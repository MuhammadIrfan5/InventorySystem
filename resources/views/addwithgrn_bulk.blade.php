                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="card border-0 rounded-lg mt-3">
                            <div class="card-body">
                                <form  method="POST" action="{{ url('add_with_grn_bulk') }}">
                                    @csrf
...
{{--                                                <textarea class="form-control pro sn_id" id="pro" name="product_sn" rows="3" placeholder="Enter product s/n here with (,) seperation"></textarea>--}}
...
@section('page-script')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#bulk_qty').keyup(function (e) {
                e.preventDefault();
                // var item_price_after_tax = 0;
                var qty = $('.bulk_qty').val();
               if(qty > 30){
                   alert("Max Bulk Quantity Exceded !")
               }
            });
