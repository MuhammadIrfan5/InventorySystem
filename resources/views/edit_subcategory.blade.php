                                            ...
                                            <div class="form-row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="approx_amount_pkr" type="text" name="approx_amount_pkr" value="{{ $subcategory->approx_price_pkr }}" placeholder="Enter Approx Amount PKR" />
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="approx_amount_dollar" type="text" name="approx_amount_dollar" value="{{ $subcategory->approx_price_dollar }}" placeholder="Enter Approx Amount Dollar" />
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="price_updated_at" type="datetime-local" value="{{ $subcategory->price_updated_at }}" name="price_updated_at"/>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="subcat_desc" name="subcat_desc" rows="4" placeholder="Enter Subcategory Description here">{{ $subcategory->subcat_desc }}</textarea>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select" id="category" name="category_id_new">
                                                            <option value=0>Select Category here</option>
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->id }}" {{ $category->id == $linked_category ? "selected" : "" }}>{{ $category->category_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select subcategory" id="subcategory" multiple name="subcategory_id[]" style="width: 100%;">
                                                            <option value=0>Select Sub Category here</option>
                                                                @foreach ($linked_subcategory as $sub_category)
                                                                    <option value="{{ $sub_category->linked_subcategory_id }}" selected>{{ \App\Subcategory::find($sub_category->linked_subcategory_id)['sub_cat_name'] }}</option>
                                                                @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                            <input type="checkbox" {{ \App\Subcategory::find($subcategory->id)['is_budget_collection'] == '1' ? 'checked' : ''}} value="1" name="is_budget_collection" class="custom-control-input" id="customSwitch5">
...
{{--                                                    <div class="form-group">--}}
{{--                                                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">--}}
{{--                                                            <input type="checkbox" {{ \App\Subcategory::find($subcategory->id)['is_fixed'] == '1' ? 'checked' : ''}} value="1" name="is_fixed" class="custom-control-input" id="customSwitch6">--}}
{{--                                                            <label class="custom-control-label" for="customSwitch6">Fixed</label>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
