        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <table class="table table-borderless">
                                    <tbody>
                                    <tr>
                                        <form method="GET" action="{{ url('budget_by_year_category_adv') }}">
                                            @csrf
                                            <td>
                    ...
                    <div class="col-md-2 col-lg-2">
                        @if(empty($capex_budget_items))
                        @else
                            <a class="btn btn-sm btn-danger mt-3 ml-3 float-right" href="{{ url('export_budget_subcat_adv/'.json_encode($filters)) }}">CSV <i class="fa fa-download" aria-hidden="true"></i></a>
                            <a class="btn btn-sm btn-danger mt-3 float-right" href="{{ url('itemexport_subcategory_adv/'.json_encode($filters)) }}">Print <i class="fa fa-download" aria-hidden="true"></i></a>
                        @endif
