...
@if($flag == 'yes')
    <div class="container"
        ...
        <h2 style="text-align: center;margin-top: 90px;"><u>Inventory Verification</u></h2>
        ...
        <div style="width: 50%;height: 300px; ">
            <form method="POST" action="{{ url('inventory_feedback/'.$find_issue->id.'/'.$flag) }}">
                @csrf
...
@else
    <div class="container"
        ...
        <h2 style="text-align: center;margin-top: 90px;"><u>Inventory Rejection</u></h2>
        <p style="font-size: 18px;margin-left: 20px;">
            User: <b>{{$data['emp_name']}}</b><br/>
            Inventory: {{$data['subcategory']}}<br/>
            Serial#: {{$data['product_sn']}}<br/>
...
{{--        <form method="POST" action="{{ url('inventory_feedback/'.$find_issue->id.'/'.$flag) }}">--}}
{{--            @csrf--}}
{{--            <p><textarea class="InputStyle" name="feedback" rows="10" cols="10" id="feedback" style="font-family:Arial, FontAwesome;font-size: 15px;"--}}
{{--                         placeholder="Enter remarks here" required></textarea>--}}
{{--                <span class="small text-danger">{{ $errors->first('feedback') }}</span>--}}
{{--                --}}{{--            <input class="InputStyle" placeholder="Email me when it's ready &#xf0e0; " style="font-family:Arial, FontAwesome" type="text"> --}}
{{--            </p>--}}
{{--            <div class="form-group mt-4 mb-0">--}}
{{--                <input type="submit" style="width: 120px; height: 30px; background-color: lightskyblue; color: black" name="add_remarks" value="Submit" class="btn btn-primary ">--}}
{{--            </div>--}}
{{--        </form>--}}
{{--    </div>--}}
