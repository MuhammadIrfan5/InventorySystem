            ...
            <div class="container">
                <div class="row mt-4">
                    <div class="col-md-10 col-lg-10">
                        <h1 class="">Edit SLA / Subscription</h1>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="card border-0 rounded-lg mt-3">
                            <div class="card-body">
                                <form method="POST" action="{{ url('sla/'.$sla->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select type_id" id="type_id" name="type_id">
                                                    ...
                                                    @foreach ($data['types'] as $type)
                                                        @if($type->id == $sla->type_id)
                                                            <option value="{{ $type->id }}" {{$type->id == $sla->type_id ? 'selected' : ''}} >{{ $type->type }}</option>
                                                        @else
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select subcategory1" id="subcategory_id" name="subcategory_id">
                                                    ...
                                                    @foreach($data['subcategories'] as $sub_cat)
                                                        @if($sub_cat->id == $sla->subcategory_id)
                                    ...
                                    <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select vendorid" id="vendors_id" name="vendor_id">
                                                    ...
                                                    @foreach ($data['vendors'] as $vendor)
                                                        <option
                                                                value="{{ $vendor->id }}" {{$vendor->id == $sla->vendor_id ? 'selected' : ''}}>{{ $vendor->vendor_name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" value="{{$sla->qty}}" name="qty" type="text" />
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="small mb-1" for="agreement_start_date">Agreement Start Date</label>
                                                <input class="form-control py-2 purchase_date"
                                                       id="contract_issue_date"  value="{{$sla->agreement_start_date}}" name="agreement_start_date" type="date"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="small mb-1" for="agreement_end_date">Agreement End Date</label>
                                                <input class="form-control py-2 purchase_date"
                                                       id="contract_end_date" value="{{$sla->agreement_end_date}}" name="agreement_end_date" type="date"
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="small mb-1" for="current_dollar_rate">Current Dollar Rate</label>
                                                <input class="form-control py-2 current_dollar_rate"
                                                       id="current_dollar_rate" value="{{$sla->current_dollar_rate}}" name="current_dollar_rate" type="number"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2 t_seperator current_sla_cost"
                                                       id="current_sla_cost" value="{{$sla->current_sla_cost}}" name="current_sla_cost" type="text"
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="remarks" name="remarks" rows="8" placeholder="Enter Remarks here">{{$sla->remarks}}</textarea>
                                                <span class="small text-danger">{{ $errors->first('remarks') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group mt-4 mb-0">
                                        <input type="submit" id="btn_add_inventory_invoice" name="add_sla" value="Add Service Level Agreement"
