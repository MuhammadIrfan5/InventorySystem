                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type='hidden' id='deptName' name='department' value=''>
                                            </div>
                                            </div>
                                            <div class="col-md-4">
                                            <div class="form-group">
...
@section('page-script')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //     console.log(url);
            // });
            $("#department_id_new").on("change",function(){
                var url =  $( "#department_id_new option:selected" ).text();
                document.getElementById('deptName').value=url;
            });
