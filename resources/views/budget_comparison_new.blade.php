                            ...
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                @foreach($capex_budget_year as $key => $budget)
                                    <tr>
                                        ...
                                        <td colspan="2" class='text-align-right'>{{ number_format($budget->to_year_u_price_dollar/$budget->my_total_rows,2)}}$</td>
                                        <td colspan="2" class='text-align-right'>{{number_format($budget->to_year_budget_qty,2) }}</td>
                                        <td colspan="2" class='text-align-right'>{{number_format($budget->from_year_u_price_dollar/$budget->my_total_rows ,2) ?? ''}}$
                                        </td>
