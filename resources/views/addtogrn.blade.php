                        ...
                        <div class="card mb-4 mt-3">
                            ...
                            <span class="text-danger">{{ $errors->first('inventory_check') }}</span>
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable_GRN" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>S.No</th>
                                                <th>Product S#</th>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="exampleCheck1" name='inventory_check[]'">
                                        ...
                                        @foreach ($inventories as $inventory)
                                            <tr>
                                                ...
                                                <td class='text-align-right'>{{ $inventory->dollar_rate ?? number_format($inventory->dollar_rate,2) }}</td>
