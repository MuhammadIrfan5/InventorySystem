...
{{--        <td class="text-center" style="width:60%; padding-left: 100px;">--}}
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered"  width="100%" cellspacing="0">
                ...
                <tr>
                    ...
                    <th colspan="8" style="text-align: center; font-size: 20px;border-color: white;"> {{$category ?? 'End User Hardware - Head Office'}}</th>
                    {{--                                    <th colspan="2" style="border-color: white;"></th>--}}
                </tr>
                <tr>
                    {{--                                    <th colspan="1" style="border-color: white;"></th>--}}
                ...
                @foreach($capex_budget as $key => $budget)
                    <tr>
                        ...
                        <td class='text-align-right' style="text-align: right;">{{ number_format($budget->mytotal_price_pkr,2) }}</td>
                        <td class='text-align-right' style="text-align: right;">{{ number_format($budget->mytotal_price_dollar,2) }}</td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">{{ number_format($c_unit_b_d,2) }}</td>
                    <td style="text-align: right;">{{ number_format($c_unit_b_p,2) }}</td>
                    <td class='text-align-right' style="text-align: right;">{{ number_format($c_qty,2) }}</td>
                    <td style="text-align: right;">{{ number_format($c_total_b_d,2) }}</td>
                    <td style="text-align: right;">{{ number_format($c_total_b_p,2) }}</td>
                </tr>
                </tfoot>
            </table>
        </div>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered"  width="100%" cellspacing="0">
                ...
                <tr>
                    <th colspan='2' style="text-align:right;">Total</th>
                    <td class='text-align-right' style="text-align: right;">{{ number_format($unit_b_d,2) }}</td>
                    <td class='text-align-right' style="text-align: right;">{{ number_format($unit_b_p,2) }}</td>
                    <td class='text-align-right' style="text-align: right;">{{ number_format($qty,2) }}</td>
                    <td class='text-align-right' style="text-align: right;">{{ number_format($total_b_d,2) }}</td>
                    <td class='text-align-right' style="text-align: right;">{{ number_format($total_b_p,2) }}</td>
                </tr>
                </tfoot>
            </table>
        </div>
