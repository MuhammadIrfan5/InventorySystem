                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                        ...
                                                        <input class="form-control py-2 pro sn_id" id="pro" name="product_sn" type="text" value="{{ $inventory->product_sn }}" placeholder="Enter product s/n here" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input class="form-control py-2 purchase_date calculatewarrantyend" id="p_date" max="{{date('Y-m-d')}}" name="purchase_date" type="date" value="{{ $inventory->purchase_date }}" placeholder="Enter purchase date here" />
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-2 t_seperator item_price" id="price" name="item_price" type="text" value="{{ $inventory->item_price }}" placeholder="Enter Item Price here" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-2" id="tax" name="tax" type="number" value="{{ str_replace("%", "", $inventory->tax) }}" placeholder="Enter Tax(%) here" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-2" id="item_price_tax" value="{{$inventory->item_price_tax}}" name="item_price_tax" type="text"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-2 warrentyend" id="warrentyend" name="warranty_end" max="{{date('Y-m-d')}}" type="text" value="{{ date('d-M-Y' ,strtotime($inventory->warranty_end)) }}" placeholder="Enter Warranty End here" readonly />
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-2" max="{{date('Y-m-d')}}" id="invoice_date" name="invoice_date" type="date" value="{{ $inventory->invoice_date }}" placeholder="Enter Invoice Date here" />
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-2" id="challan_date" name="delivery_challan_date" type="date" max="{{date('Y-m-d')}}" value="{{ $inventory->delivery_challan_date }}" placeholder="Enter Delivery Challan Date here" />
