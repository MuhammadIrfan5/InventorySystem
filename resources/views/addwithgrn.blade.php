                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ url('inventory') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select" id="invtype" name="inventorytype_id">
                                                    ...
                                                    @foreach ($inventorytypes as $inventorytype)
                                                        <option
                                                            value="{{ $inventorytype->id }}">{{ $inventorytype->inventorytype_name }}</option>
                                                    @endforeach
                                                </select>
                                                <span
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2 pro sn_id" id="pro" name="product_sn"
                                                       type="text" placeholder="Enter product s/n here"/>
                                                <span
                                                    class="small text-danger pro_msg">{{ $errors->first('product_sn') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2 purchase_date calculatewarrantyend"
                                                       id="p_date" max="{{ date('Y-m-d')}}" name="purchase_date"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="small mb-1" for="item_price_tax">Item Price After
                                                    TAX(%)</label>
                                                <input class="form-control py-2" id="item_price_tax"
                                                       name="item_price_tax" type="text"
                                                       placeholder="Item Price After Tax%" readonly/>
                                                <span
                                                    class="small text-danger">{{ $errors->first('item_price_tax') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2" id="ccost" name="current_cost"
                                                       type="text" placeholder="Enter Current Cost here"/>
                                                <span
                                                    class="small text-danger">{{ $errors->first('current_cost') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="small mb-1" for="current_location">Current
                                                    Location</label>
                                                <input class="form-control py-2" id="current_location"
                                                       name="current_location" type="text"
                                                       placeholder="Enter Current Location here"/>
                                                <span
                                                    class="small text-danger">{{ $errors->first('current_location') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="small mb-1" for="current_consumer">Current
                                                    Consumer</label>
                                                <input class="form-control py-2" id="current_consumer"
                                                       name="current_consumer" type="text"
                                                       placeholder="Enter Current Consumer here"/>
                                                <span
                                                    class="small text-danger">{{ $errors->first('current_consumer') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2" id="licence" name="licence_key"
                                                       type="text" placeholder="Enter Licence Key here"/>
                                                <span
                                                    class="small text-danger">{{ $errors->first('licence_key') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="small mb-1" for="SLA">SLA</label>
                                                <input class="form-control py-2" id="SLA" name="sla" type="text"
                                                       placeholder="Enter SLA here"/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2" id="warrentycheck"
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="small mb-1" for="operating_system">Operating
                                                    System</label>
                                                <input class="form-control py-2" id="operating_system"
                                                       name="operating_system" type="text"
                                                       placeholder="Enter Operating System here"/>
                                                <span
                                                    class="small text-danger">{{ $errors->first('operating_system') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="small mb-1" for="SAP_tag">SAP Tag</label>
                                                <input class="form-control py-2" id="SAP_tag" name="SAP_tag" type="text"
                                                       placeholder="Enter SAP Tag here"/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2" id="Capacity" name="capacity"
                                                       type="text" placeholder="Enter Capacity here"/>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2" id="hard_drive" name="hard_drive"
                                                       type="text" placeholder="Enter Hard Drive here"/>
                                                <span
                                                    class="small text-danger">{{ $errors->first('hard_drive') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="small mb-1" for="Processor">Processor</label>
                                                <input class="form-control py-2" id="Processor" name="processor"
                                                       type="text" placeholder="Enter Processor here"/>
                                                <span class="small text-danger">{{ $errors->first('processor') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="small mb-1" for="process_generation">Process
                                                    Generation</label>
                                                <input class="form-control py-2" id="process_generation"
                                                       name="process_generation" type="text"
                                                       placeholder="Enter Process Generation here"/>
                                                <span
                                                    class="small text-danger">{{ $errors->first('process_generation') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2" id="display_type" name="display_type"
                                                       type="text" placeholder="Enter Display Type here"/>
                                                <span
                                                    class="small text-danger">{{ $errors->first('display_type') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="small mb-1" for="DVD_rom">DVD Rom</label>
                                                <input class="form-control py-2" id="DVD_rom" name="DVD_rom" type="text"
                                                       placeholder="Enter DVD Rom here"/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2" id="RAM" name="RAM" type="text"
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2" id="invoice" name="invoice_number"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2" max="{{ date('Y-m-d')}}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2" id="Insurance" name="insurance"
                                                       type="text" placeholder="Enter Insurance here"/>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-2" id="challan" name="delivery_challan"
                                                       type="text" placeholder="Enter Delivery Challan here"/>
                                                <span
                                                    class="small text-danger">{{ $errors->first('delivery_challan') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="small mb-1" for="challan_date">Delivery Challan
                                                    Date</label>
                                                <input class="form-control py-2" max="{{ date('Y-m-d')}}"
                                                       id="challan_date" name="delivery_challan_date" type="date"
                                                       placeholder="Enter Delivery Challan Date here"/>
                                                <span
                                                    class="small text-danger">{{ $errors->first('delivery_challan_date') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="form-row mt-5">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="other" name="other_accessories"
                                                          rows="3"
                                                          placeholder="Enter Other Accessories here"></textarea>
                                                <span
                                                    class="small text-danger">{{ $errors->first('other_accessories') }}</span>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <span
                                                    class="small text-danger">{{ $errors->first('good_condition') }}</span>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="verification"
                                                       name="verification">
                                                <label class="form-check-label" for="verification">Verification</label>
                                                <span
                                                    class="small text-danger">{{ $errors->first('verification') }}</span>
                                            </div>
                                        </div>
                                        <!-- <div class="col-md-1">
                                        </div> -->
                                    ...
                                    <div class="form-group mt-4 mb-0">
                                        <input type="submit" name="add_inventory" value="Add with GRN"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#make").on("change", function () {
                ...
                console.log(modelId)
                modelId.empty();
                    modelId.append('<option value="" class="o1">Select Sub Category here</option>');
